...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/src_top")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/devar_Tbot")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/devsrc_top")]])
